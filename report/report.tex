...
\begin{document}
	...
	\begin{figure}[!htb]
		...
		\caption
		{Score achieved by the \textsc{Subsumption} agent with $\epsilon$-greedy exploration.}
	...
	\begin{figure}[!htb]
		...
		\caption
		{Score achieved by the \textsc{Subsumption} agent with optimistic-prior exploration.}
	...
	\begin{figure}[!htb]
		...
		\caption
		{Score achieved by the \textsc{Subsumption} agent with $\epsilon$-greedy and optimistic-prior exploration.}
